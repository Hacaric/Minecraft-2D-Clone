#
#
#------------ source: https://github.com/alexandr-gnrk/perlin-1d
#
#
import random
import math
...
class PerlinNoise():
    def __init__(self, 
            ...
            octaves=1, interp=Interp.COSINE, use_fade=False, range_=[-1,1]):
    ...
    def get(self, x):
        ...
        result = ((result + 1) / 2) * (self.range_[1] - self.range_[0]) + self.range_[0]
        return result
